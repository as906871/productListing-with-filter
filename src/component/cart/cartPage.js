      ...
      <div className="max-w-4xl mx-auto bg-white p-6 rounded-2xl shadow-lg">
        ...
        <div className="mt-8 flex justify-between items-center border-t pt-4">
          <button
            ...
            className="bg-red-300 text-black border border-black flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-red-50 hover:text-red-600 hover:border-red-400 transition-all duration-200"
          >
             Clear Cart
          </button>
